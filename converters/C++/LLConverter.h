...
public:
    LLConverter(LLIR &ir, Tree &tree, LLIR *custom_lexer_code = nullptr, LLIR::variable *access_var = nullptr, std::string namespace_name = "") : LLConverter_base(ir, tree, custom_lexer_code, access_var) {
