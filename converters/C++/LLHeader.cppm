...
export class LLHeader : public LLStringConvertions {
    ...
    void createDFAVars(const DFAS &dfas, const std::pair<DFAS::StateSet, DFAS::StateSetLocationMap> &states_pair, std::ostringstream &out) const;
    ...
    void create_parser_header(std::ostringstream &out, const DFAS &dfas, const std::pair<DFAS::StateSet, DFAS::StateSetLocationMap> &states_pair) const;
