...
export class LLHeader : public LLStringConvertions {
    ...
    void writeEnum(std::ostringstream& out, const vector<vector<std::string>>& enm) const;
    void createTokensEnum(std::ostringstream &out, const vector<vector<std::string>> &tokens) const;
    void createRulesEnum(std::ostringstream &out, const vector<vector<std::string>> &rules) const;
    void getTypesFromStdlib(std::ostringstream& out) const;
    void addTokensToString(const vector<vector<std::string>> &tokens, std::ostringstream &out) const;
    void addRulesToString(const vector<vector<std::string>> &rules, std::ostringstream &out) const;
    void createToStringFunction(const vector<vector<std::string>> &tokens, const vector<vector<std::string>> &rules, std::ostringstream &out) const;
    ...
    void create_lexer_header(std::ostringstream &out, const vector<vector<std::string>> &tokens) const;
