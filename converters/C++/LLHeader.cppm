...
export class LLHeader : public LLStringConvertions {
    ...
    void convert_inclosed_map(std::ostringstream &out, LangAPI::inclosed_map map) const;
    void convert_single_assignment_data(std::ostringstream &out, LangAPI::var_type type, std::string name) const;
    void write_data_block(std::ostringstream &out, const LangAPI::DataBlockList &dtb) const;
    void createTypesNamespace(std::ostringstream &out, const LangAPI::DataBlockList &data_block_tokens, const LangAPI::DataBlockList &data_block_rules) const;
    ...
    void create_get_namespace(std::ostringstream &out, std::string namespace_name, const LangAPI::DataBlockList &data_block_tokens, const LangAPI::DataBlockList &data_block_rules) const;
};