...
export class LLHeader : public LLStringConvertions {
    ...
    void createDFAVars(const DFAS &dfas, const DFAS::StateSet_t &states_set, std::ostringstream &out) const;
    ...
    void create_parser_header(std::ostringstream &out, const DFAS &dfas, const DFAS::StateSet_t &states_set) const;
