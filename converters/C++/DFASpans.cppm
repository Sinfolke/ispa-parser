...
public:
    ...
    DFASpans(std::ostringstream &out, const std::string &namespace_name, const DFA::Collection &dfas, const utype::unordered_map<stdu::vector<std::string>, std::size_t> *dct) : out(out), namespace_name(namespace_name), dfas(dfas), dct(dct) {}
};