...
if (data.type() == typeid(str_t)) {
        ...
        indentLevel--;
        os << std::string(indentLevel, '\t') << "]";
    }	else if (data.type() == typeid(Types::cll_if_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::cll_if_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "block"<< ": ";
		printRule(os, dt.block, indentLevel, false);
		os << "\n";
	...
	else if (data.type() == typeid(Types::cll_variable_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::cll_variable_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "post"<< ": ";
		printRule(os, dt.post, indentLevel, false);
		os << "\n";
	...
	else if (data.type() == typeid(Types::cll_function_arguments_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::cll_function_arguments_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "second"<< ": ";
	...
	else if (data.type() == typeid(Types::cll_function_parameters_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::cll_function_parameters_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "second"<< ": ";
		printRule(os, dt.second, indentLevel, false);
		os << "\n";
		os << std::string(indentLevel, '\t') << "first"<< ": ";
	...
	else if (data.type() == typeid(Types::cll_cll_function_call_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::cll_cll_function_call_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "body"<< ": ";
	...
	else if (data.type() == typeid(Types::cll_function_decl_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::cll_function_decl_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "value"<< ": ";
	...
	else if (data.type() == typeid(Types::cll_expr_logical_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::cll_expr_logical_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "right"<< ": ";
	...
	else if (data.type() == typeid(Types::cll_expr_compare_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::cll_expr_compare_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "sequence"<< ": ";
	...
	else if (data.type() == typeid(Types::cll_expr_arithmetic_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::cll_expr_arithmetic_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "sequence"<< ": ";
		printRule(os, dt.sequence, indentLevel, false);
		os << "\n";
		os << std::string(indentLevel, '\t') << "operators"<< ": ";
	...
	else if (data.type() == typeid(Types::cll_expr_term_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::cll_expr_term_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "sequence"<< ": ";
		printRule(os, dt.sequence, indentLevel, false);
		os << "\n";
		os << std::string(indentLevel, '\t') << "operators"<< ": ";
	...
	else if (data.type() == typeid(Types::cll_var_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::cll_var_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "value"<< ": ";
		printRule(os, dt.value, indentLevel, false);
		os << "\n";
		os << std::string(indentLevel, '\t') << "op"<< ": ";
	...
	else if (data.type() == typeid(Types::cll_loop_while_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::cll_loop_while_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "block"<< ": ";
		printRule(os, dt.block, indentLevel, false);
		os << "\n";
		os << std::string(indentLevel, '\t') << "expr"<< ": ";
	...
	else if (data.type() == typeid(Types::cll_loop_for_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::cll_loop_for_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "block"<< ": ";
		printRule(os, dt.block, indentLevel, false);
		os << "\n";
	...
	else if (data.type() == typeid(Types::object_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::object_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "values"<< ": ";
	...
	else if (data.type() == typeid(Types::use_unit_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::use_unit_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "value"<< ": ";
		printRule(os, dt.value, indentLevel, false);
		os << "\n";
		os << std::string(indentLevel, '\t') << "name"<< ": ";
	...
	else if (data.type() == typeid(Types::use_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::use_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "second"<< ": ";
		printRule(os, dt.second, indentLevel, false);
		os << "\n";
		os << std::string(indentLevel, '\t') << "first"<< ": ";
	...
	else if (data.type() == typeid(Types::Rule_rule_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::Rule_rule_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "quantifier"<< ": ";
	...
	else if (data.type() == typeid(Types::Rule_name_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::Rule_name_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "nested_name"<< ": ";
	...
	else if (data.type() == typeid(Types::Rule_data_block_regular_datablock_key_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::Rule_data_block_regular_datablock_key_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "val"<< ": ";
	...
	else if (data.type() == typeid(Types::Rule_data_block_templated_datablock_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::Rule_data_block_templated_datablock_data>(data);
indentLevel++;		os << std::string(indentLevel, '\t') << "second_name"<< ": ";
	...
	else if (data.type() == typeid(Types::Rule_data)) {
		os << "{\n";
		auto dt = std::any_cast<Types::Rule_data>(data);
