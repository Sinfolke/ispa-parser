...
namespace VacParser {
	...
	namespace FlatTypes {
		...
		struct candidate_declarator_value_weight {
			 std::vector<::ISPA_STD::Node<Tokens, AUTO_1>> value;
		};
		struct candidate_declarator_value_any {
			 std::variant<::ISPA_STD::Node<Tokens, ID>, ::ISPA_STD::Node<Tokens, STRING>> list;
		...
		struct candidate_declarator_value {
			 std::variant<::ISPA_STD::Node<Tokens, AUTO_3>, ::ISPA_STD::Node<Tokens, AUTO_2>> modifier;
		...
		struct alias {
			 ...
			 std::vector<::ISPA_STD::MatchResult<Rules, alias_value>> value;
		};
	...
	namespace Types {
		...
		struct alias : FlatTypes::alias {
			using value = FlatTypes::alias_value;
		};
	...
	class Lexer : public ::ISPA_STD::Lexer_base<Tokens, Token> {
		...
		static ::ISPA_STD::DFAAPI::EmptyState<Tokens, Token> dfa_state_189;
