...
public:
    DFABuilder(const AST::Tree& ast, const AST::RuleMember &rule, const stdu::vector<std::string> &fullname, bool addStoreActions);
    DFABuilder(const AST::Tree& ast, const stdu::vector<AST::RuleMember> &rules, const stdu::vector<std::string> &fullname, bool addStoreActions);
    DFABuilder(const AST::Tree& ast, const stdu::vector<stdu::vector<std::string>> &names, bool addStoreActions);
    DFA& get() {
        return dfa;
    }
};