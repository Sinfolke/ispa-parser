...
export namespace LLIR {
    ...
    public:
        ...
        BuilderBase(BuilderData& data, const TreeAPI::RuleMember &rule) : BuilderData(data), rule(&rule), BuilderUtility(nullptr) {
            setUtilityPointer(&this->data);
        }
        virtual ~BuilderBase() = default;
    };
}
std::ostream &operator<<(std::ostream &os, const LLIR::BuilderBase &data);