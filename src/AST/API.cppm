...
export namespace AST {
    ...
    struct rvalue {
        stdu::variant<String, Number, Boolean, Array, Object, At, ID> value;
        bool isString() const;
        bool isNumber() const;
    ...
    struct CllExprValue {
        stdu::variant<std::shared_ptr<CllExprGroup>, std::shared_ptr<CllVariable>, CllFunctionCall, CllMethodCall, rvalue> value;
        bool isGroup() const;
    ...
    struct Cll {
        stdu::variant<CllVar, CllIf, CllExpr> value;
        bool isVar() const;
        bool isIf() const;
        bool isExpr() const;
        CllVar &getVar();
    ...
    struct RuleMember {
        ...
        bool isAutoGenerated = false;
        bool isInline = false;
        stdu::variant<std::monostate, String, RuleMemberName, RuleMemberGroup, RuleMemberOp, RuleMemberCsequence, RuleMemberAny, RuleMemberNospace, RuleMemberEscaped, RuleMemberHex, RuleMemberBin, Cll> value;
    ...
    struct DataBlock {
        stdu::variant<std::monostate, RegularDataBlock, RegularDataBlockWKeys, TemplatedDataBlock> value;
