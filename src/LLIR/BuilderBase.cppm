...
export namespace LLIR {
    ...
    public:
        ...
        static void undoRuleResult(ValueType &type);

        // cll helper functions
        static auto CllTypeToIR(const AST::CllType &type) -> Type;
    ...
    protected:
        ...
        stdu::vector<ExportsAfterBuild> exports_list;
        // helper functions
        ...
        static auto deduceUvarType(const Variable &var, const Variable &shadow_var) -> Type;
        static auto deduceVarTypeByProd(const AST::RuleMember &mem) -> ValueType;
        static auto deduceTypeFromRvalue(const AST::rvalue &value) -> ValueType;
        ...
        static void insertVariablesOnTop(Statements &insertPlace, Statements& table);
